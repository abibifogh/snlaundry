...
- Reports show **who** accepted / cleaned / marked ready / took payment, plus breakdowns **by shift** (AM 06–14, PM 14–22, Night 22–06) and **by staff**. Each shift shows the **total collected**, and tapping that amount reveals the **cash / card split**. The report can also be **filtered and exported (CSV/PDF) to a single shift** within any date range.
